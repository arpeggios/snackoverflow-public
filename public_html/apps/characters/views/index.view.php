  ...
  <table>
    ...
    <tbody>
      <?php foreach ($characters as $character) : ?>
        <tr>
          <td>
            <a href='character.php?<?php echo http_build_query(['mode' => 'view', 'character' => $character->charName, 'id' => $character->id]); ?>'><?php echo e($character->charName); ?></a>
          </td>
          ...
          <td>
            ...
            <a role='button' href='index.php?<?php echo http_build_query(['id' => $character->id, 'action' => 'delete']) ?>'><img src='assets/icons/delete_24dp_FILL0_wght400_GRAD0_opsz24.svg' aria-label='delete button' /></a>
          </td>
        </tr>
      <?php endforeach; ?>
    </tbody>
